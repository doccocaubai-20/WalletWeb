...
const TopUp = () => {
  ...
  const loadTopupData = useCallback(async (showSkeleton = true) => {
    ...
    try {
      ...
      const banks = (banksResponse.data || []).filter(isActiveLinkedBank);
          ...
          {method === 'linked' && (
            <div className="wallet-topup-card wallet-fade-up wallet-delay-1">
              ...
              {linkedBanks.length === 0 && (
                <div className="wallet-topup-empty">
                  Bạn chưa liên kết ngân hàng. Vui lòng vào trang quản lý ngân hàng liên kết để thêm mới.
                </div>
              )}
